...
@WebServlet(
        name = "heavyVehicleReg",
        urlPatterns = "/heavyVehicleReg",
        loadOnStartup = 1
)
public class HeavyVehicleReg extends HttpServlet {

    public HeavyVehicleReg() {
        System.out.println("Running HeavyVehicleReg");
    }

    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("HeavyVehicleReg is processing the request");
