...
@WebServlet(
        name = "fourWheeler",
        urlPatterns = "/fourWheelerReg",
        loadOnStartup = 1
)
public class FourWheeler extends HttpServlet {

    public FourWheeler() {
        System.out.println("Running FourWheelerRegForm");
    }

    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("FourWheelerRegForm is processing the request");
